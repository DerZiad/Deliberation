	...
	<layout:put block="content" type="REPLACE">
		<div class="main-card mb-3 card">
			<div class="card-body">
				...
				<form action="/etudiant/consulter" method="POST">
					<div class="col-md-6">
					...
					<div class="col-md-9">
						<div class="position-relative form-group">
							<a id="download" href="${url}" class="btn btn-success">Download
								Releve note</a>
						</div>
						...
						<c:forEach var="note" items="${notes}">
							<tr>
								...
								<td><a style="color: black">
										...
										${note.idComposed.etudiant.last_name_fr}</a></td>
								<td><a style="color: black">
										${note.idComposed.module.libelle_module}</a></td>
								<td><a style="color: black"> ${note.note}</a></td>
