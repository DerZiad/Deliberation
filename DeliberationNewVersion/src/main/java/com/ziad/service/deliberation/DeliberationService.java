...
public class DeliberationService implements DeliberationInterface {
	...
	private void readExcelOrdinaire(AnneeAcademique annee,Element element,MultipartFile file, Double coefficientControl,Double coefficientTp,Double coefficientExam)
	...
	private void readExcelRattrapage(AnneeAcademique annee,Element element,MultipartFile file,Double coefficientExam) throws CSVReaderOException, IOException, InvalidCredinals {
		//Exception
				InvalidCredinals credinals = new InvalidCredinals();
				List<NoteElement> notesElement = new ArrayList<NoteElement>();
	...
	public void delibererModule(Long idModule,Long idAnne) throws DeliberationModuleNotAllowed, DeliberationElementNotAllowed {
