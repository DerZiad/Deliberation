...
public class IntialiserBachelor {
	...
	@SuppressWarnings("unused")
	@Autowired
	private NoteElement noteElementRepository;
	@Autowired
	...
	private List<User> createStructureScolaire() throws Exception{
		...
		Professeur bekri = new Professeur("Ali", "Bekri", "ali.bekri@gmail.com", new User("bekri",passwordEncoder.encode("test123"),""));
		...
		Professeur oubelkacem = new Professeur("Ali", "Oubelkacem", "ali.oubelkacem@gmail.com", new User("oubelkacem",passwordEncoder.encode("test123"),""));
		...
		Professeur benhlima = new Professeur("Said", "Benhlima", "said.benhlima@gmail.com", new User("benhlima",passwordEncoder.encode("test123"),""));
	...
	public boolean isEmpty() {
		...
		if(test)System.out.println("[ ! ] - Data base not empty");
		return !test;
	}
}
