...
public class ProfesseurController {
	...
	private final static String ATTRIBUTS_ANNEE_ACADEMIQUE = "annee";
	private final static String ATTRIBUT_ELEMENT = "element";
	private final static String ATTRIBUT_TYPE_RATT = "rattrapage";
	private final static String ATTRIBUT_TYPE_ORDI = "ordinaire";
	...
	public ModelAndView listerEtudiants(@PathVariable("id_element") Long id_element)
		...
		model.addObject(ATTRIBUTS_ANNEE_ACADEMIQUE, besoins.get(1));
		model.addObject(ATTRIBUT_ELEMENT,(Element)besoins.get(2));
		model.addObject(ATTRIBUT_TYPE_ORDI,TypeNote.EXAM_ORDINAIRE);
		model.addObject(ATTRIBUT_TYPE_RATT,TypeNote.EXAM_RATTRAPAGE);
		return model;
	}
	...
	public void makeListtoDownload(@PathVariable("id_element") Long id_element,
		...
		professeur_metier.generateExcel(id_element, id_annee, response,type);
