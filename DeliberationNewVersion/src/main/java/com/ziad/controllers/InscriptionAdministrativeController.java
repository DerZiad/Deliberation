...
public class InscriptionAdministrativeController {
	...
	private final static String ATTRIBUT_INSCRIPTION_ADMINISTRATIVE = "ia";
	private final static String ATTRIBUT_COUNTRIES= "countries";
	private final static String ATTRIBUT_INSCRIPTION_ADMINISTRATIVE_NAVBAR = "InscriptionAdministrative";
	private final static String ATTRIBUT_EDIT_INSCRIPTION_ADMINISTRATIVE_NAVBAR = "ListInscriptionAdministartive";
	private final static String ATTRIBUT_LISTE_INSCRIPTION_ADMINISTRATIVE_NAVBAR = "listAdministartive";
	
	private final static String REDIRECT_LISTE_INSCRIPTIONS_ADMINISTRATIVES = "redirect:/admin/inscription/ListInscriptionAdministrative";
	
	private final static String PAGE_LISTE_INSCRIPTIONS_ADMINISTRATIVES = "inscription_administrative/ListInscriptionAdministrative";
	private final static String PAGE_EDIT_INSCRIPTION_ADMINISTRATIVE = "inscription_administrative/ModifierInscriptionAdministrative";
	private final static String PAGE_UPLOAD_INSCRIPTION_ADMINISTRATIVE = "inscription_administrative/UploadInscriptionAdministrative";
	private final static String PAGE_INSCRIPTION_ADMINISTRATIVE = "inscription_administrative/InscriptionAdministrative";
	...
	public ModelAndView InscriptionAdministrative(@PathVariable("inscriptionenligne") Long idInscription)
		...
		ModelAndView model = new ModelAndView(PAGE_INSCRIPTION_ADMINISTRATIVE);
		model.addObject(ATTRIBUT_INSCRIPTION_ADMINISTRATIVE_NAVBAR, ACTIVE);// will be used in the nav-bar
...
//---------------------------------action :création d'une nouvelle inscription administrative-----------------------------//
	...
	public ModelAndView createANewInscriptionAdministrative(@RequestParam("annee_academique") Long id_annee_academique,
		...
		return new ModelAndView(REDIRECT_LISTE_INSCRIPTIONS_ADMINISTRATIVES);
	}
...
//-----------------------------------------page affichant la liste des inscriptions administratives-------------------------------//
	...
	public ModelAndView listInscriptionAdministratives() throws UnsupportedEncodingException, DataNotFoundExceptions {
		...
		model.addObject(ATTRIBUT_LISTE_INSCRIPTION_ADMINISTRATIVE_NAVBAR, ACTIVE);
...
//***************** Filtrage et affichage de la liste ********************************************
	...
	public ModelAndView listInscriptionAdministrative(
		...
		ModelAndView model = new ModelAndView(PAGE_LISTE_INSCRIPTIONS_ADMINISTRATIVES);
		ArrayList<Object> list = inscription_metier.listerInscriptionsAdministratives();
		model.addObject(ATTRIBUT_LISTE_INSCRIPTION_ADMINISTRATIVE_NAVBAR, ACTIVE);
	...
	public ModelAndView PageModifierInscriptionAdministrative(@PathVariable("id_filiere") Long id_filiere,
		...
		ModelAndView model = new ModelAndView(PAGE_EDIT_INSCRIPTION_ADMINISTRATIVE);
		model.addObject(ATTRIBUT_EDIT_INSCRIPTION_ADMINISTRATIVE_NAVBAR, ACTIVE);
		model.addObject(ATTRIBUT_INSCRIPTION_ADMINISTRATIVE, ia);
		model.addObject(ATTRIBUT_ETUDIANT, (List<InscriptionEnLigne>) besoins.get(1));
		model.addObject(ATTRIBUT_LIST_FILIERES, (List<Filiere>) besoins.get(2));
		model.addObject(ATTRIBUT_LIST_ANNEE_ACADEMIQUES, (List<AnneeAcademique>) besoins.get(3));
		model.addObject(ATTRIBUT_COUNTRIES, besoins.get(4));
		return model;
	}

	@GetMapping("/inscription/uploadinscription")
	public ModelAndView PageUploadInscriptionAdministrative() {
		ModelAndView model = new ModelAndView(PAGE_UPLOAD_INSCRIPTION_ADMINISTRATIVE);
		model.addObject(ATTRIBUT_INSCRIPTION_ADMINISTRATIVE_NAVBAR, ACTIVE);
		return model;
	}
