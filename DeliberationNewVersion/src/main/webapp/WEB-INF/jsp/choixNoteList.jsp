...
<layout:extends name="layout.jsp">
	<layout:put block="content" type="REPLACE">
		<form method="POST"
			action="/note/listNote">
			<div class="main-card mb-3 card">
				<div class="card-body">
					<h5 class="card-title">Choix de l'element de module</h5>
...
<div class="form-row">
			...
			<div class="form-row">
				<div class="col-md-6">
					<div class="position-relative form-group">
						<label for="Filiere" class="">Element</label> <select
							name="element" id="element" class="form-control"
							onchange="changeFuncModule()">
							<option selected default disabled>Choisir l'element de module</option>
