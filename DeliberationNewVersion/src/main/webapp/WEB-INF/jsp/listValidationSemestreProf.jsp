	...
	<layout:put block="content" type="REPLACE">
		...
		<div class="main-card mb-3 card">
			<div class="card-body">
				...
				<form method="get" action="/delib/XCLSemstre">
				<input name="semestre" id="semestre" value="${semestre.id_semestre}"
					...
					<tbody>
						<c:forEach var="i" items="${etudiants}">
							<tr >
								...
								<td><a style="color: black"><c:if test="${i.note_semestre > 0}"> 
								${i.note_semestre}  </c:if></a></td>
