...
 **_M. Ali OUBELKACEM_** , responsable projet, pour ses conseils éclairés, sa patience, sa disponibilité et
pour la confiance qu'il m'a accordée dès l'ébauche du projet et tout au long de ces quatre mois.

 **_M. Ali BEKRI_** , responsable projet, pour m'avoir accordé toute la confiance nécessaire pour élaborer
ce projet librement, et avoir mis à ma disposition tous les moyens nécessaires.

 **_Mme. CHAYMAA LAMINI_** , enseignante-chercheuse, pour son investissement, sa contribution et
...
Gestion des étudiants et tous ce
...
Délibération automatique après
...
Une possibilité de modification
de compte pour chaque acteur X^
...
Une interface étudiant qui
permet d’imprimer un PV X^
Archivage des notes après
chaque délibération faite X^
...
**_Le tout sera mis sous la lumière et sous_**
...
infrastructure similaire à un serveur d'applications J2EE. Il prend donc
...
d'applications J2EE et des EJBs).
...
 "Cours initiation à Java EE", de l'école EISTI: https://www.cours-gratuit.com/coursj2ee/cours-
initiation-a-java-ee-pdf/download?chk=0ee7541bc76772411a73795372f36c09
...
[http://yassine.ab.free.fr/Documents/maven-guide-fr.pdf](http://yassine.ab.free.fr/Documents/maven-guide-fr.pdf)
...
[http://researchers.lille.inria.fr/~yabouzid/cours3.pdf](http://researchers.lille.inria.fr/~yabouzid/cours3.pdf)
