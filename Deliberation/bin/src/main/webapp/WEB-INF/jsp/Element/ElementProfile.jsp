			...
			<div class="col-md-3">
				<div class="main-card mb-3 card">
					<div class="card-body">
						...
						<a href="/admin/module/profile/${module.id_module }/element/create"><button
								class="mb-2 mr-2 btn btn-primary btn-block">Les
								éléments du module</button></a>
			...
			<div class="col-md-9">
				<div class="main-card mb-3 card">
					<div class="card-body">
						...
						<form action="/admin/module/profile/${module.id_module}/element/modify"
							method="POST">
							<input type="hidden" name="idelement" value="${element.id_element }"/>
							<div class="position-relative form-group">
								<label for="name" class="">Nom: </label><input name="name"
									id="name" placeholder="Nom de l'établissement" type="text"
									class="form-control" value="${element.libelle_element }">
							</div>
							<div class="position-relative form-group">
								<label for="professeur_id" class="">Professeur
									Responsable:</label> <select name="professeur_id" id="exampleSelect"
									class="form-control">
									<c:forEach var="professeur" items="${professeurs }">
										<option value="${professeur.id_professeur}"
											<c:if test="${module.responsable_module.id_professeur eq professeur.id_professeur }"> selected</c:if>>
							...
							<div class="position-relative form-group">
								<label for="coefficient" class="">Coefficient: </label><input
									name="coefficient" id="coefficient" placeholder="Coefficient"
									type="text" class="form-control"
									value="${element.coeficient }">
							</div>
							<div class="position-relative form-group">
							...
							formaction="/admin/module/profile/${element.module.id_module}/element/${element.id_element}/delete"
